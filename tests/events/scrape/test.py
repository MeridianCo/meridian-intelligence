...
class EventScraperTests(unittest.TestCase):
    ...
    @patch("src.services.events.scrape.event_scraping.fetch_url", side_effect=lambda url: DUPLICATE_BLOGS[url])
    ...
    @patch("src.services.events.scrape.event_scraping.fetch_url", return_value=SEED_HTML)
    ...
    @patch(
        "src.services.events.scrape.event_scraping.fetch_url",
